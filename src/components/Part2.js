...
function Part2() {
  return (
      <div>
        <img src={image} alt='image' className='singleImage'/>

    <div>
        <h1 className='community'>Curated by Black communities</h1>
        <h6 className='xbk'>
             Microsoft community selections
             including Black<br /> creators, leads,
              and experiences. Visit aka.ms/xbk.
        </h6>
    </div>

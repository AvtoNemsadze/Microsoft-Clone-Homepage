...
function Slider() {
  ...
  return (
    <section className="section">
      ...
      <p>Do it all with a perfect balance of sleek design, speed, and <br/>
      immersive audio. If you have questions before you buy, chat with<br/>
      a product expert.
      </p>
        <h1>Take charge in the new year with<br/> Microsoft 365</h1>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 74 74" height="34" width="34">
      ...
      {/* <div className="container-dots">
                {Array.from({length: 2}).map((item, index) => (
                    ...
                    className={setImage === index + 1 ? "dot active" : "dot"}
                    ></div>
                ))}
            </div> */}
    </section>
